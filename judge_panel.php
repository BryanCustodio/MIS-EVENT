        ...
        <div class="container">
          <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            ...
            <span class="icon-bar"></span>
               ...
               <a class="brand" href="#"><img src="uploads/<?php echo $company_logo; ?>" width="100" height="23" />&nbsp; <font size="3">SMP Judge</font></a>
...
<?php 
    ...
    while ($cont_row = $cont_query->fetch()) { 
        ...
        <?php if ($getContestant_id == $con_idTab) { ?>
            <li class="active"><a href="judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=<?php echo $con_idTab; ?>">
                <strong><?php echo $num . ". " . $cont_row['fullname']; ?></strong>
            </a></li>
        <?php } else { ?>
            <li><a href="judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=<?php echo $con_idTab; ?>">
                <?php echo $num . ". " . $cont_row['fullname']; ?>
            </a></li>
        <?php } 
                   ...
                   <a href="judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=allTally">View Tally</a>  
                     <?php  } 
                                        ...
                                        <div class="container">
                                          ...
                                          <font size="4">SMP Judging System &middot; &COPY; <?= date ("Y") ?></font>
                                          <hr />
                                          ...
                                          <tr>
                                          <td align="center"><img src="uploads/<?php echo $company_logo; ?>" width="100" height="35" /></td>
                                         </tr>
                                         <tr>
                                          <td align="center">
...
<!--Start Submit Scoring Contestant -->
...
<form method="POST" action="submit_judging.php">
            ...
            <td>
                <table align="center" class="table table-bordered">
                    <tr>
                        ...
                        ?>
                        <td width="10">
                            <center><font size="2"><?php echo $crit_row['criteria']." - <b>".$crit_row['percentage']." Points</b>"; ?></font></center>
                        </td>
                        <?php } ?>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" class="form-control" style="width: 100%;" 
                                   name="cp<?php echo $crit_row['criteria_ctr']; ?>" 
                                   min="0" max="<?php echo $crit_row['percentage']; ?>" step="0.1" required>
                        </td>
                        <?php } ?>
                    </tr>
                </table>
    ...
    <divs class="modal-footer">
    <?php 
    if ($totzxzxzxzxz < 1 || $totzxzxzxzxz > 100) { ?>
        <div class="alert alert-danger pull-right">
            <strong>The Total Percentage must be between 1% and 100%. Please contact the event organizer.</strong> 
        </div>  
    <?php } else { ?>
